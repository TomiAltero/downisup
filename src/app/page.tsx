        ...
        <main className="flex-grow">
          <section className="mt-10 bg-custom-blue relative h-screen w-full flex flex-col justify-center items-center snap-start overflow-hidden">
            ...
            <section className="flex flex-col items-center z-10">
              <div className="bg-custom-blue shadow-lg shadow-indigo-500/50 rounded-lg">
                <ButtonHome />
              </div>
            </section>
          </section>
          ...
          <section className="min-h-[calc(100vh-100px)] w-full flex flex-col md:flex-row snap-start transition-transform duration-1200 ease-in-out relative fade-in">
            <div className="w-full md:w-4/12 flex flex-col justify-center items-center text-center p-6 md:p-10 z-10 bg-custom-blue md:bg-transparent">
              ...
              <p className="text-white text-lg md:text-xl leading-relaxed">
                ES UN DESAFÍO Y UN RETO, TANTO PARA LA PERSONA, COMO PARA SU
                ENTORNO&quot;
              </p>
            </div>
            ...
            <div className="w-full md:w-8/12 flex flex-col justify-center items-center p-6 md:p-10 z-10">
              <h2 className="lg:text-4xl md:text-5xl font-bold text-custom-blue mt-5 mb-5 md:mb-6">
                NUESTRA HISTORIA
              </h2>
              <p className="text-base md:text-lg text-custom-blue mb-6 md:mb-10">
                Comenzó en 2015 cuando decidimos comenzar a organizar charlas,
                acciones y más, trabajando para lograr el cambio que buscábamos.
                Nos basamos en la existencia de un movimiento nacional llamado
                Down is Up, con sede en varias provincias, con el fin de
                satisfacer la necesidad de contención, atención e información
              ...
              <p className="text-custom-blue text-base md:text-lg mb-6">
                <Image
                  ...
                  height={16}
                />{" "}
                Promover los derechos reconocidos en la Convención Internacional
                ...
                <Image
                  ...
                  height={16}
                />{" "}
                Visibilizar el Síndrome de Down, mediante acciones de educación,
                formación y actividades sociales y culturales, fortaleciendo la
                convivencia.
                <br />
                <Image
                  src="/tick.png"
                  ...
                  height={16}
                />{" "}
                Fomentar la vida independiente y la autonomía de las personas
                con síndrome de Down.
              </p>
              <div className="bg-pink-600 shadow-lg shadow-pink-500/50 rounded-lg ">
                <ButtonShowMore />
              </div>
            </div>
          </section>
          ...
          <section className="min-h-[calc(100vh-120px)] w-full flex flex-col md:flex-row snap-start transition-transform duration-1200 ease-in-out relative fade-in">
            ...
            <div className="w-full md:w-6/12 flex flex-col justify-center items-center p-6 md:p-10 z-10 bg-white">
              ...
              />
              <a
                href="https://maps.app.goo.gl/cpvhnUq2XH37BnCi8"
                className="text-custom-blue text-lg mt-5 mb-5 leading-relaxed flex items-center hover:underline"
              >
                <PinIconSvg />
            ...
            <div className="w-full md:w-6/12 flex flex-col justify-center items-center text-center p-6 md:p-10 z-10 bg-custom-blue md:bg-transparent">
              ...
              <p className="text-white text-base lg:mx-30 md:mx-10 leading-relaxed">
                Programas de tratamiento diseñados para mejorar la calidad de
                vida y la participación de personas con discapacidad en diversos
                ámbitos. En los consultorios, se enfocan en trabajar de manera
                integral con profesionales y familias para lograr la autonomía
                de cada paciente, estableciendo objetivos específicos y
                enfatizando la comunicación y la experiencia como fundamentales
          ...
          <footer className="w-full py-5 bg-gray-800 mt-auto fade-in">
            <div className="flex justify-center space-x-8 flex-wrap">
              ...
              <p className="text-white text-lg md:text-md text-center">
                “Sabemos que el potencial de las personas con síndrome de Down
                no tiene límites.”
              </p>
            </div>
          </footer>
          ...
          <section className="min-h-screen w-full flex flex-col md:flex-row snap-start transition-transform duration-1200 ease-in-out relative fade-in">
            <div className="w-full md:w-4/12 flex flex-col justify-center items-center lg:-mt-30 md:mt-0 p-6 md:p-10 z-10 bg-custom-blue md:bg-transparent">
              <div className="flex flex-col items-center md:items-start">
                ...
                <p className="text-white text-lg mt-5 mb-5 leading-relaxed flex items-center">
                  <MessageIconSvg />
                  <a
                    href="mailto:fundaciondownisupcbacba@gmail.com"
                    className="text-white text-lg hover:underline"
                  >
                    fundaciondownisupcbacba@gmail.com
                  </a>
                </p>
                <a
                  href="https://maps.app.goo.gl/cpvhnUq2XH37BnCi8"
                  className="text-white text-lg mt-5 mb-5 leading-relaxed flex items-center hover:underline"
                >
                  <PinIconSvg />
                  Pérez de Herrera 2053
                </a>
            ...
            <div className="w-full md:w-8/12 flex flex-col justify-center items-center p-6 md:p-10 z-10 sm:mx-4 md:mx-0 relative min-h-screen pb-10">
