...
interface SpeechSessionFormProps {
  hijoId: string;
}

const SpeechSessionForm: React.FC<SpeechSessionFormProps> = ({ hijoId }) => {
...
const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
  ...
  try {
    const response = await fetch('https://downisup-api-production.up.railway.app/api/medicalData/speechTherapies', {
      method: 'POST',
      headers: {
