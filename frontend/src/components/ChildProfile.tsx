...
export default function ChildProfile() {
  ...
  const dropdownItems = hijos
    .map((hijo) => {
      return [
        {
          icon: <Profile size={20} className="text-black" />,
  ...
  return (
    <div className="relative border-2 p-2 rounded-xl w">
      <div
          ...
          <div className="text-sm font-semibold text-black">
            {selectedHijo ? (
              <div className="flex items-center">
                <Profile size={20} className="text-black" />
